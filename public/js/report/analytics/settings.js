...
opendxp.registerNS("opendxp.bundle.googlemarketing.report.analytics.settings");
/**
 * @private
 */
opendxp.bundle.googlemarketing.report.analytics.settings = Class.create({
            ...
            items: [
                ...
                },
                {
                    ...
                    value: "&nbsp;<br />" + t("analytics_settings_description") + "<br /><br />"
                        + t('only_required_for_reporting_in_opendxp_but_not_for_code_integration'),
                    cls: "opendxp_extra_label"
                },
                {
                    xtype: "panel",
            ...
            items: [
                {
                    ...
                    items: [{
                        ...
                        value: t('only_required_for_reporting_in_opendxp_but_not_for_code_integration'),
...
opendxp.bundle.googlemarketing.settings.broker.push("opendxp.bundle.googlemarketing.report.analytics.settings");
