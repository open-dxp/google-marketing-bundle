...
Autoloader::addNamespace('OpenDxp\Bundle\GoogleMarketingBundle\Tests', __DIR__);
Autoloader::addNamespace('OpenDxp\Bundle\GoogleMarketingBundle\Tests', __DIR__ . '/_support');
