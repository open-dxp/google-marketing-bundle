...
opendxp.registerNS("opendxp.bundle.googlemarketing.custom.definition.analytics");
/**
 * @private
 */
opendxp.bundle.googlemarketing.custom.definition.analytics = Class.create({
    ...
    initialize: function (sourceDefinitionData, key, deleteControl, columnSettingsCallback) {
        ...
        this.dimensionStore = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_bundle_googlemarketing_reports_analytics_getdimensions'),
                reader: {
                    type: 'json',
                    rootProperty: "data",
                    idProperty: "id"
        ...
        this.metricsStore = new Ext.data.JsonStore({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_bundle_googlemarketing_reports_analytics_getmetrics'),
                reader: {
                    type: 'json',
                    rootProperty: "data",
                    idProperty: "id"
        ...
        this.segementsStore = new Ext.data.JsonStore({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_bundle_googlemarketing_reports_analytics_getsegments'),
                reader: {
                    rootProperty: "data",
                    idProperty: "id"
                }
            ...
            items: [
                {
                    ...
                    store: new Ext.data.JsonStore({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: Routing.generate('opendxp_bundle_googlemarketing_reports_analytics_getprofiles'),
                            reader: {
                                type: 'json',
                                rootProperty: "data",
                                idProperty: "id"
...
if (opendxp.bundle.customreports && opendxp.bundle.customreports.custom.definition) {
    opendxp.bundle.customreports.custom.definition.analytics = opendxp.bundle.googlemarketing.custom.definition.analytics;
}
