...
In order to use Google Analytics you have to install the OpenDxpGoogleMarketingBundle.
...
use OpenDxp\Bundle\GoogleMarketingBundle\EventListener\Frontend\GoogleAnalyticsCodeListener;
...
-   the definition of available blocks in the [Tracker implementation](../src/Tracker/Tracker.php#L32)
-   the [templates](../templates/Analytics/Tracking/Google/Analytics)
...
The central part of the Google tracking is the `OpenDxp\Bundle\GoogleMarketingBundle\Tracker\Tracker` class which is defined as service and
...
use OpenDxp\Bundle\GoogleMarketingBundle\Model\Event\TrackingDataEvent;
use OpenDxp\Bundle\GoogleMarketingBundle\Tracker\Tracker;
use OpenDxp\Bundle\GoogleMarketingBundle\Event\GoogleAnalyticsEvents;
...
{% extends "@OpenDxpGoogleMarketing/Analytics/Tracking/Google/Analytics/universalTrackingCode.html.twig" %}
