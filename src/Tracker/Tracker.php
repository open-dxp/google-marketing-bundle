...
use OpenDxp\Bundle\GoogleMarketingBundle\Config\ConfigProvider;
...
class Tracker extends AbstractTracker
{
    ...
    private function doBuildCode(SiteId $siteId, Config $config, array $siteConfig): string
    {
        ...
        if ($siteConfig['gtagcode']) {
            $template = '@OpenDxpGoogleMarketing/Analytics/Tracking/Google/Analytics/gtagTrackingCode.html.twig';
            ...
            $template = '@OpenDxpGoogleMarketing/Analytics/Tracking/Google/Analytics/asynchronousTrackingCode.html.twig';
        } else {
            $template = '@OpenDxpGoogleMarketing/Analytics/Tracking/Google/Analytics/universalTrackingCode.html.twig';
        }
