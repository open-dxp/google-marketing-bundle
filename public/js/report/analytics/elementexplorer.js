...
opendxp.registerNS("opendxp.bundle.googlemarketing.report.analytics.elementexplorer");
/**
 * @private
 */
opendxp.bundle.googlemarketing.report.analytics.elementexplorer = Class.create(opendxp.bundle.customreports.abstract, {
    ...
    getIconCls: function () {
        return "opendxp_icon_analytics_explorer";
    },
    ...
    getContentPanel: function () {
        ...
        this.store = new Ext.data.JsonStore({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_bundle_googlemarketing_reports_analytics_dataexplorer'),
                extraParams: {
                    type: type,
                    id: id,
                    path: path
...
if (opendxp.bundle.customreports && opendxp.bundle.customreports.broker) {
    ...
    opendxp.bundle.customreports.broker.addReport(opendxp.bundle.googlemarketing.report.analytics.elementexplorer, "analytics");
}
